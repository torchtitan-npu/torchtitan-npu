...
def test_deepseek_v3_mapping():
    ...
    assert "deepseek" in impl.__name__.lower() or impl.__name__ == "npu_apply_rotary_emb_deepseek"
...
def test_qwen3_mapping():
    ...
    assert impl is not None
    assert "qwen" in impl.__name__.lower() or impl.__name__ == "npu_apply_rotary_emb_qwen"
