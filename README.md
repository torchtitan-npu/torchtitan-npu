...
git clone拉取源码后进入到torchtitan-npu目录下使用pip命令行安装

```shell
pip install -e . ，
```

具体请参考 [部署文档](https://gitcode.com/cann/torchtitan-npu/blob/master/docs/user-guide/installation.md) 安装torchtitan-npu及其依赖软件。
