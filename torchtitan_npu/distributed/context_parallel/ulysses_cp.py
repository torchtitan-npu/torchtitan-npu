...
class AllToAll(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):
        ...
        # Reversed all-to-all
        torch.distributed.all_to_all(grad_output_list, grad_list, group=ctx.mesh.get_group())
...
class UlyssesContextParallelContext(CustomContextParallelContext):
    ...
    def apply_patches(self):
        ...
        orig_sdpa_forward = self._orig_sdpa_forward = ScaledDotProductAttentionWrapper.forward
